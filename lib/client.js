  ...
  factory: (require) => {
    ...
    function listenForVoice() {
      ...
      const onSpeaking = (event) => {
        ...
        // LOCAL FORK: in live sentence mode a piece may already be synthesizing on
        // the host while nothing is queued here yet, so ask the host to abort its
        // in-flight synthesis and empty its queue as well. Without this the reply
        // resumes speaking the moment that piece settles.
